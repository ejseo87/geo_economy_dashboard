...
독일(3.0%)과 함께 OECD 최상위 그룹에 속하는 수준입니다.
  ...
  // 유사국 선정 로직 (실제로는 더 복잡한 알고리즘 적용)
  static List<CountryData> _selectSimilarCountries(String indicatorCode) {
    // 경제규모, 발전수준, 지역적 특성을 고려한 유사국 선정
    final Map<String, List<CountryData>> similarCountriesMap = {
      'NY.GDP.MKTP.KD.ZG': [
        // GDP 성장률
        CountryData(
          countryCode: 'JPN',
    ...
    return similarCountriesMap[indicatorCode] ?? [];
  }
}
